...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hypercolumns_param', full_name='caffe.LayerParameter.hypercolumns_param', index=57,
...
_HYPERCOLUMNSPARAMETER = _descriptor.Descriptor(
  name='HyperColumnsParameter',
  full_name='caffe.HyperColumnsParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_train', full_name='caffe.HyperColumnsParameter.is_train', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_num', full_name='caffe.HyperColumnsParameter.sample_num', index=1,
      number=2, type=5, cpp_type=1, label=1,
...
_LAYERPARAMETER.fields_by_name['hypercolumns_param'].message_type = _HYPERCOLUMNSPARAMETER
...
DESCRIPTOR.message_types_by_name['HyperColumnsParameter'] = _HYPERCOLUMNSPARAMETER
...
class HyperColumnsParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _HYPERCOLUMNSPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.HyperColumnsParameter)
